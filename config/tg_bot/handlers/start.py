...
from tg_bot.test import format_phone_number,passport_number_checker,is_valid_full_name
...
async def confirm_handler(call: CallbackQuery, state: FSMContext) -> None:
    ...
    user = UniversityApplication.objects.create(
        ...
        current_education=data.get("current_education"),
        region=data.get("region"),
        desired_major=data.get("desired_major"),
        education_language=data.get("education_language"),
        study_mode=data.get("study_mode"),
        important_factor=data.get("important_factor"),
        help_source=data.get("help_source"),
        bot_source=data.get("bot_source"),
