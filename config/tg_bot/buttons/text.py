...
regions_valid = [
    ...
    "🌾 Jizzax viloyati", "🚢 Sirdaryo viloyati", "🏜 Qoraqalpogʻiston Respublikasi",
    "🏙 Город Ташкент", "🌆 Ташкентская область", "🌿 Андижанская область", "🍏 Ферганская область",
    ...
    "🌾 Джизакская область", "🚢 Сырдарьинская область", "🏜 Республика Каракалпакстан",
    ortga,nazad
]
