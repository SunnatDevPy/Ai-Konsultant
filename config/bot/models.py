...
class UniversityApplication(models.Model):
    ...
    current_education = models.CharField(max_length=15, choices=CURRENT_EDUCATION_CHOICES)
    region = models.CharField(max_length=100)
    desired_major = models.CharField(max_length=255)
    education_language = models.CharField(max_length=5, choices=LANGUAGE_CHOICES)
    study_mode = models.CharField(max_length=10, choices=STUDY_MODE_CHOICES)
    financial_aid = models.CharField(max_length=10, choices=FINANCIAL_AID_CHOICES)
    important_factor = models.CharField(max_length=20, choices=IMPORTANT_FACTOR_CHOICES)
    help_source = models.CharField(max_length=10, choices=HELP_SOURCE_CHOICES)
    tg_id=models.IntegerField(unique=True)
    bot_source = models.CharField(max_length=10, choices=SOURCE_CHOICES)
    created_at = models.DateTimeField(auto_now_add=True)
